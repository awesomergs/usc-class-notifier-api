...
test("isDarkModeSupportedPage matches Calendar, CourseBin, Departments, Courses, TuitionRefundInsurance, Checkout, and ClearedSections paths, case-insensitively", () => {
